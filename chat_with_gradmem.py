...
def build_model_config(cli_args, base_config=None):
    ...
    return GradMemGPTConfig(
        ...
        use_write_lora=cli_args["use_write_lora"],
        write_lora_r=cli_args["write_lora_r"],
        write_lora_alpha=cli_args["write_lora_alpha"],
        write_lora_dropout=cli_args["write_lora_dropout"],
        write_lora_target_modules=cli_args.get("write_lora_target_modules"),
        lora_mem_placement=cli_args["lora_mem_placement"],
        lora_mem_r=cli_args["lora_mem_r"],
        lora_mem_alpha=cli_args["lora_mem_alpha"],
        lora_mem_dropout=cli_args["lora_mem_dropout"],
        lora_mem_layers=cli_args.get("lora_mem_layers"),
        lora_mem_target_modules=cli_args.get("lora_mem_target_modules"),
        kv_mem_layers=cli_args.get("kv_mem_layers"),
        freeze_backbone=cli_args["freeze_backbone"],
