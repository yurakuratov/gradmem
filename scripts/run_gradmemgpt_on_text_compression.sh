...
# Prepared dataset path (produced by prepare_pg19_chunks.py)
DATASET_NAME="pg19_chunks_w8000"
...
RUN_NAME=gradmem_${MODEL_NAME}_N${MAX_CONTEXT_LENGTH}
...
for N in "${N_VALUES[@]}"; do
  ...
  EXP_PATH="./runs/${DATASET_NAME}/${RUN_NAME}/run_${N}"
  ...
  CMD=(
    ...
    run_gradmemgpt_on_text_compression.py
    --exp_path "$EXP_PATH"
