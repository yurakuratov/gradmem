...
# INITIAL_CHECKPOINT_PATH=/workspace-SR006.nfs2/bulatov/rmt/test-time/test_time_gd/runs/phonebook/N8/rmt2segm_gpt2_mem32_K1_mem_proj_whead_bs_256_lr_1e-03_constant_with_warmup-from_N4/run_1/checkpoint-118500/model.safetensors
INITIAL_CHECKPOINT_PATH=/workspace-SR006.nfs2/bulatov/rmt/test-time/test_time_gd/runs/phonebook/N16/rmt2segm_gpt2_mem32_K1_mem_proj_whead_bs_256_lr_1e-03_constant_with_warmup-from_N8/run_1/checkpoint-169500/model.safetensors
N_MEM_TOKENS=32
for N_PAIRS in 32; do
    PER_DEVICE_BATCH_SIZE=$((256*8/N_PAIRS))
    ...
    RUN_NAME=${RUN_NAME}_${LR_SCHEDULER_TYPE}-from_N8
