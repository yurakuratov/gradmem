...
for N in $N_VALUES; do
  ...
  for STAGE_INDEX in "${!CE_WEIGHTS[@]}"; do
    ...
    STAGE_WANDB_NAME=${MODEL}_curriculum_ce${CE_WEIGHT}_N${N_PAIRS_IN_SEGMENT}x${N_SEGMENTS_IN_CONTEXT}_ilr${INNER_LR}_rot${MEMORY_ROTATION}${ENERGY_ARCH_SUFFIX}_run${N}
